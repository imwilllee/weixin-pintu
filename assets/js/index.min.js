...
! function(e, t) {
    e("data/jigsawGame", function(e, t, n) {
        ...
        i.nextFrame = function(e) {
            ...
            if (6e4 > e) return (e / 1e3).toFixed(3) + "''";
            var t = parseInt(e / 6e4);
            return t + "'" + (e % 6e4 / 1e3).toFixed(3) + "''"
        ...
        function r(e, t) {
            var n = this;
            t = t || {},
                n.itemQuery = t.itemQuery || "[dragitem='1']",
                n.dragOut = t.dragOut || !1,
                n.layer = e, s.extend(n, o()),
                n.init()
        }
        function i(e, t) {
    ...
    e("page/jigsaw/p/picture", function(e, t, n) {
        ...
        function r(e) {
            ...
            //p.dom.find(".kapics").html(p.currentGame.pic + 1 + "/" + n.pic.length),
            u.set(f, p.currentGame), p.jigsawGame.setConfig(r)
        }
        var i = e("af"),
        ...
        p.init = function(e) {
            ...
            e.html(t), p.jigsawGame = s, p.jigsawGame.init(e), p.dom = e, p.jigsawGame.on("picOver", function(e) {
                ...
                p.dom.find(".play-info").show().find(".first-guide").html("<span class='retry'>\u91cd\u65b0\u5f00\u59cb</span>").show()
            }), p.dom.delegate(".nextpic", "click", function() {
                //p.playNextPic()
            }), p.dom.delegate(".retry", "click", function() {
                p.playAgan(), p.dom.find(".play-info").show().find(".first-guide").hide()
            }), p.dom.delegate(".share", "click", function() {
            })
            // console.log(p.dom);
        }, p.enter = function() {
            p.play()
        ...
        p.showNextKa = function() {
            if (!p.nextKaLayer) {
                ...
                e.delegate(".next", "click", function() {
                    ...
                    p.playAgan()
                }), e.delegate(".share", "click", function(){
                })
            }
         ...
         p.picOver = function(e) {
            var imgs = {
               //"0,0": 'http://p0.qhimg.com/t013889da7ee2a40e17.jpg',
            };
            ...
            var _picka = [p.currentGame.ka, p.currentGame.pic].join(',');

            //dataForWeixin.title = "我只用了" + step + '步就完成了这张拼图，不服来战~';
            dataForWeixin.title = '我在"' + gameTitle + '"中用' + step +'步就得到了完整的TA，你也来试一下吧！';
            ...
            }), p.hasNextPic() ? (p.dom.find(".first-guide").html("\u606d\u559c\u4f60\uff0c\u5b8c\u6210\u62fc\u56fe"), p.dom.find(".play-info").show().find(".playing-over").show()) : p.hasNextKa() ? p.showNextKa() : (p.dom.find(".menu-box1").show()/*p.showTongguan()*/
 )},

        p.showTongguan = function() {
            new m({
                message: "小子，你太神了<br/>竟然只用了" + step + "步^_^",
                calcelTxt: "\u70ab\u8000\u4e00\u4e0b",
                sureTxt: "\u91cd\u65b0\u6765\u8fc7",
                sure: function() {
                    p.currentGame = {
